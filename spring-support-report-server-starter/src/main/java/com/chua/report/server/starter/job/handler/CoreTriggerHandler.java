...
import static com.chua.report.server.starter.job.JobHelper.PRE_READ_MS;
import static com.chua.report.server.starter.job.handler.RingTriggerHandler.pushTimeRing;
