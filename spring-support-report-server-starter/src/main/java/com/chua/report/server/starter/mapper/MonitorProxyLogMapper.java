 ...
 * @since 2024/9/16
 */
public interface MonitorProxyLogMapper extends BaseMapper<MonitorProxyLog> {
     ...
     */
    Page<MonitorProxyLimitLogResult> pageForLog(@Param("page") Page<MonitorProxyLog> page, @Param("query") MonitorProxyLog entity);
     ...
     */
    List<MonitorProxyLimitLogResult> listForGeo(@Param("page") Page<MonitorProxyLog> page, @Param("query") MonitorProxyLog entity);
}