 ...
 * @author CH    
 */
public interface MonitorProxyLogService extends IService<MonitorProxyLog>{
         ...
         */
        Page<MonitorProxyLimitLogResult> pageForLog(Page<MonitorProxyLog> page, MonitorProxyLog entity);
         ...
         */
        LogStatistic listForGeo(Page<MonitorProxyLog> page, MonitorProxyLog entity);
}
