 ...
 */
@Data
@TableName(value = "monitor_sys_gen_column")
public class MonitorSysGenColumn implements Serializable {
    /**
     * 主键
     */
     ...
     */
    @ColumnDesc("查询方式（等于、不等于、大于、小于、范围）")
     ...
     */
    @ColumnDesc("显示类型（文本框、文本域、下拉框、复选框、单选框、日期控件）")
     ...
     * @param tableName   表名称
     * @param column1     结果集
     * @return {@link MonitorSysGenColumn}
     */
    public static MonitorSysGenColumn createSysGenColumn(Dialect dialect,
                                                         MonitorSysGenTable sysGenTable,
                                                         String tableName,
