 ...
 * @author CH
 */
public abstract class AbstractSwaggerQueryController<S extends IService<T>, T> extends AbstractSwaggerUpdateController<S, T>{
    ...
    abstract public Wrapper<T> createWrapper(T entity);
}
