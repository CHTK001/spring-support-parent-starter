...
import com.chua.sync.data.support.adapter.SpiConfigAdapterManager;
...
import com.chua.sync.data.support.service.sync.MonitorSyncSpiService;
import com.chua.sync.data.support.util.SpiParameterResolver;
import com.chua.sync.data.support.util.SyncDataSourceFactory;
