 ...
 */
package com.chua.report.client.starter.jpom.socket;
...
import com.chua.report.client.starter.jpom.util.FileSearchUtil;
import com.chua.report.client.starter.jpom.util.SocketSessionUtil;
...
public class AgentWebSocketConsoleHandle extends BaseAgentWebSocketHandle {
    ...
    private boolean silentMsg(ConsoleCommandOp consoleCommandOp, Session session) {
        return consoleCommandOp == ConsoleCommandOp.heart;
