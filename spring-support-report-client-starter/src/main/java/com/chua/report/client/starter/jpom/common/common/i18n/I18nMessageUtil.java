 ...
 */
package com.chua.report.client.starter.jpom.common.common.i18n;
...
public class I18nMessageUtil {
    ...
    public static String getLanguageByRequest() {
        ...
        if (servletRequestAttributes != null) {
            ...
            String header = JakartaServletUtil.getHeader(request, Header.ACCEPT_LANGUAGE.getValue(), CharsetUtil.CHARSET_UTF_8);
