 ...
 */
package com.chua.report.client.starter.jpom.script;
...
import com.chua.report.client.starter.jpom.model.EnvironmentMapBuilder;
...
public class NodeScriptProcessBuilder extends BaseRunScript implements Runnable {
    ...
    private ClientNodeScriptServer clientNodeScriptServer;
    ...
    private NodeScriptProcessBuilder(NodeScriptModel nodeScriptModel, String executeId, String args, Map<String, String> paramMap) {
        ...
        if (clientNodeScriptServer == null) {
            clientNodeScriptServer = SpringUtil.getBean(ClientNodeScriptServer.class);
        }
        //
        scriptFile = clientNodeScriptServer.toExecuteFile(nodeScriptModel);
        //
