 ...
 */
package com.chua.report.client.starter.jpom.agent.controller;
...
import com.chua.report.client.starter.jpom.agent.common.commander.ProjectCommander;
import com.chua.report.client.starter.jpom.agent.common.commander.SystemCommander;
import com.chua.report.client.starter.jpom.agent.common.interceptor.NotAuthorize;
import com.chua.report.client.starter.jpom.agent.configuration.AgentConfig;
import com.chua.report.client.starter.jpom.agent.configuration.MonitorConfig;
...
import com.chua.report.client.starter.jpom.common.common.RemoteVersion;
...
public class IndexController extends BaseAgentController {
    ...
    public IJsonMessage<JSONObject> getDirectTop() {
        ...
        try {
            ...
            JSONObject topInfo = com.chua.report.client.starter.jpom.agent.util.OshiUtils.getSimpleInfo(monitorConfig.orElse(null));
            jsonObject.put("simpleStatus", topInfo);
            // 系统固定休眠时间
            jsonObject.put("systemSleep", com.chua.report.client.starter.jpom.agent.util.OshiUtils.NET_STAT_SLEEP + com.chua.report.client.starter.jpom.agent.util.OshiUtils.CPU_STAT_SLEEP);

            JSONObject systemInfo = com.chua.report.client.starter.jpom.agent.util.OshiUtils.getSystemInfo();
    ...
    public IJsonMessage<List<JSONObject>> getProcessList(String processName, Integer count) {
        try {
            ...
            List<JSONObject> processes = com.chua.report.client.starter.jpom.agent.util.OshiUtils.getProcesses(processName, Convert.toInt(count, 20));
    ...
    public IJsonMessage<List<JSONObject>> diskInfo() {
        try {
            List<JSONObject> list = com.chua.report.client.starter.jpom.agent.util.OshiUtils.fileStores();
    ...
    public IJsonMessage<List<JSONObject>> hwDiskInfo() {
        try {
            List<JSONObject> list = com.chua.report.client.starter.jpom.agent.util.OshiUtils.diskStores();
            return JsonMessage.success("", list);
        } catch (Throwable e) {
    ...
    public IJsonMessage<List<JSONObject>> networkInterfaces() {
        try {
            List<JSONObject> list = com.chua.report.client.starter.jpom.agent.util.OshiUtils.networkInterfaces();
            return JsonMessage.success("", list);
        } catch (Throwable e) {
