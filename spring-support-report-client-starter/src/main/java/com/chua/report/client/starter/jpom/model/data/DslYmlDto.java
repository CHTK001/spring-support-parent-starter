...
public class DslYmlDto extends BaseJsonModel {
     ...
     * @return 结果
     */
    public static BaseProcess tryDslProcess(DslYmlDto build, String opt) {
        return Optional.ofNullable(build)
                .map(DslYmlDto::getRun)
                .map(run -> (BaseProcess) ReflectUtil.getFieldValue(run, opt))
                .orElse(null);
    }
    ...
    public boolean hasRunProcess(String opt) {
        ...
        BaseProcess baseProcess = (BaseProcess) ReflectUtil.getFieldValue(run, opt);
     ...
     * @return 结果
     */
    public BaseProcess tryDslProcess(String opt) {
     ...
     * @return 结果
     */
    public BaseProcess getDslProcess(String opt) {
        BaseProcess baseProcess = this.tryDslProcess(opt);
     ...
     * 重新加载
     *
     * @see com.chua.report.client.starter.jpom.socket.ConsoleCommandOp
     */
