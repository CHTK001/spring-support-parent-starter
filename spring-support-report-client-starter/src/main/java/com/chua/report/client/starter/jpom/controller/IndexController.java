 ...
 */
package com.chua.report.client.starter.jpom.controller;
...
import com.chua.report.client.starter.jpom.service.script.ClientNodeScriptServer;
...
import com.chua.report.client.starter.jpom.common.RemoteVersion;
import com.chua.report.client.starter.jpom.common.commander.ProjectCommander;
import com.chua.report.client.starter.jpom.common.commander.SystemCommander;
import com.chua.report.client.starter.jpom.common.i18n.I18nMessageUtil;
import com.chua.report.client.starter.jpom.common.interceptor.NotAuthorize;
import com.chua.report.client.starter.jpom.configuration.AgentConfig;
import com.chua.report.client.starter.jpom.configuration.MonitorConfig;
import com.chua.report.client.starter.jpom.model.data.NodeProjectInfoModel;
...
import com.chua.report.client.starter.jpom.service.manage.ProjectInfoService;
...
public class IndexController extends BaseAgentController {
    ...
    public IJsonMessage<JSONObject> getDirectTop() {
        ...
        try {
            ...
            JSONObject topInfo = com.chua.report.client.starter.jpom.util.OshiUtils.getSimpleInfo(monitorConfig.orElse(null));
            jsonObject.put("simpleStatus", topInfo);
            // 系统固定休眠时间
            jsonObject.put("systemSleep", com.chua.report.client.starter.jpom.util.OshiUtils.NET_STAT_SLEEP + com.chua.report.client.starter.jpom.util.OshiUtils.CPU_STAT_SLEEP);

            JSONObject systemInfo = com.chua.report.client.starter.jpom.util.OshiUtils.getSystemInfo();
    ...
    private JSONObject getJpomInfo() {
        ...
        List<NodeScriptModel> list = clientNodeScriptServer.list();
        JSONObject jsonObject = new JSONObject();
    ...
    public IJsonMessage<List<JSONObject>> getProcessList(String processName, Integer count) {
        try {
            ...
            List<JSONObject> processes = com.chua.report.client.starter.jpom.util.OshiUtils.getProcesses(processName, Convert.toInt(count, 20));
    ...
    public IJsonMessage<List<JSONObject>> diskInfo() {
        try {
            List<JSONObject> list = com.chua.report.client.starter.jpom.util.OshiUtils.fileStores();
    ...
    public IJsonMessage<List<JSONObject>> hwDiskInfo() {
        try {
            List<JSONObject> list = com.chua.report.client.starter.jpom.util.OshiUtils.diskStores();
            return JsonMessage.success("", list);
        } catch (Throwable e) {
    ...
    public IJsonMessage<List<JSONObject>> networkInterfaces() {
        try {
            List<JSONObject> list = com.chua.report.client.starter.jpom.util.OshiUtils.networkInterfaces();
            return JsonMessage.success("", list);
        } catch (Throwable e) {
