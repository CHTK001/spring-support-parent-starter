 ...
 */
package com.chua.report.client.starter.jpom.common.plugin;
...
//    }
    ...
    public void initialize(ConfigurableApplicationContext applicationContext) {
        //init();
        // 扫描插件 实现
        Set<Class<?>> classes = ClassUtil.scanPackage("com.chua.starter.monitor.jpom", IPlugin.class::isAssignableFrom);
        ...
        log.debug("load plugin count:{}", pluginMap.size());
    }
