...
public abstract class BaseAgentController extends BaseJpomController {
    ...
    private static String getUserName(HttpServletRequest request) {
        String name = JakartaServletUtil.getHeaderIgnoreCase(request, Const.JPOM_SERVER_USER_NAME);
    ...
    protected String getWorkspaceId() {
        return JakartaServletUtil.getHeader(getRequest(), Const.WORKSPACE_ID_REQ_HEADER, CharsetUtil.CHARSET_UTF_8);
    }
