...
public class ProjectLogBackController extends BaseAgentController {
    ...
    public void download(String key, HttpServletResponse response) {
        ...
        try {
            ...
            if (logBack.exists() && logBack.isDirectory()) {
                ...
                JakartaServletUtil.write(response, JsonMessage.getString(400, I18nMessageUtil.get("i18n.no_corresponding_file_colon.8970") + logBack.getPath()), MediaType.APPLICATION_JSON_VALUE);
            }
        } catch (Exception e) {
    ...
    public void export(HttpServletResponse response) {
        ...
        if (!file.exists()) {
            JakartaServletUtil.write(response, JsonMessage.getString(400, I18nMessageUtil.get("i18n.log_file_not_found.7f2e") + file.getPath()), MediaType.APPLICATION_JSON_VALUE);
            return;
        }
