 ...
 */
package com.chua.report.client.starter.jpom.controller.manage;
...
import com.chua.report.client.starter.jpom.common.commander.CommandOpResult;
...
import com.chua.report.client.starter.jpom.controller.manage.vo.DiffFileVo;
import com.chua.report.client.starter.jpom.model.AfterOpt;
import com.chua.report.client.starter.jpom.model.BaseEnum;
import com.chua.report.client.starter.jpom.model.data.AgentWhitelist;
import com.chua.report.client.starter.jpom.model.data.NodeProjectInfoModel;
import com.chua.report.client.starter.jpom.service.ClientWhitelistDirectoryService;
import com.chua.report.client.starter.jpom.service.ProjectFileBackupService;
import com.chua.report.client.starter.jpom.socket.ConsoleCommandOp;
import com.chua.report.client.starter.jpom.util.CommandUtil;
import com.chua.report.client.starter.jpom.util.CompressionFileUtil;
...
@Slf4j
public class ClientProjectFileControl extends BaseAgentController {
    ...
    public ClientProjectFileControl(ClientWhitelistDirectoryService clientWhitelistDirectoryService,
    ...
    public IJsonMessage<List<JSONObject>> getFileList(String id, String path) {
        ...
        AgentWhitelist whitelist = clientWhitelistDirectoryService.getWhitelist();
...
//		}
        ...
        try {
            ...
            if (file.isDirectory()) {
                JakartaServletUtil.write(response, JsonMessage.getString(400, I18nMessageUtil.get("i18n.folder_download_not_supported.c3b7")), MediaType.APPLICATION_JSON_VALUE);
                return;
            }
            JakartaServletUtil.write(response, file);
        } catch (Exception e) {
            log.error(I18nMessageUtil.get("i18n.download_exception.e616"), e);
            JakartaServletUtil.write(response, JsonMessage.getString(400, I18nMessageUtil.get("i18n.download_failed_retry.c113"), e.getMessage()), MediaType.APPLICATION_JSON_VALUE);
        }
    }
