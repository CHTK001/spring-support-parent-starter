 ...
 */
package com.chua.report.client.starter.jpom.common.commander;
...
import com.chua.report.client.starter.jpom.common.i18n.I18nThreadUtil;
import com.chua.report.client.starter.jpom.configuration.ProjectConfig;
import com.chua.report.client.starter.jpom.configuration.ProjectLogConfig;
import com.chua.report.client.starter.jpom.exception.IllegalArgument2Exception;
import com.chua.report.client.starter.jpom.model.RunMode;
import com.chua.report.client.starter.jpom.model.data.DslYmlDto;
import com.chua.report.client.starter.jpom.model.data.NodeProjectInfoModel;
import com.chua.report.client.starter.jpom.model.system.NetstatModel;
...
import com.chua.report.client.starter.jpom.service.script.DslScriptServer;
...
//    }
    ...
    private String webHooks(String token, NodeProjectInfoModel nodeProjectInfoModel, String type, Object... other) {
        ...
        map.put("type", type);
        map.put("JPOM_WEBHOOK_EVENT", "PROJECT");
