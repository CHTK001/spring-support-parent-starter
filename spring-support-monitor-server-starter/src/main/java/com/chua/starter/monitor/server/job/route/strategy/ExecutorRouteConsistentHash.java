...
public class ExecutorRouteConsistentHash extends ExecutorRouter {
    ...
    public MonitorRequest hashJob(int jobId, List<MonitorRequest> addressList) {

        // ------A1------A2-------A3------
        // -----------J1------------------
        TreeMap<Long, MonitorRequest> addressRing = new TreeMap<>();
        ...
        SortedMap<Long, MonitorRequest> lastRing = addressRing.tailMap(jobHash);
        if (!lastRing.isEmpty()) {
    ...
    public List<MonitorRequest> route(TriggerParam triggerParam, List<MonitorRequest> addressList) {
        return Collections.singletonList(hashJob(triggerParam.getJobId(), addressList));
    }
