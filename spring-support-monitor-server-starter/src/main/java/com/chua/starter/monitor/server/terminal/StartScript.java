...
public class StartScript {
    ...
    public StartScript(MonitorProjectService monitorProjectService, SocketSessionTemplate socketSessionTemplate) {
    ...
    private String getRunScript(MonitorProjectVersion monitorProjectVersion, MonitorProject monitorProject) {
        return FileUtils.normalize(monitorProject.getProjectProjectPath(), monitorProjectVersion.getVersionRunScript());
    }
}
